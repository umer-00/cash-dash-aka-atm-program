...
if (pinAnswer.pin === myPin) {console.log(chalk.greenBright("correct pincode ... \n\nlogin successfull"));
...
if (operationAnswer.operation === "fast cash")
{
    ...
    if(fastCashAnswer.fastCash> myBalance) {console.log(chalk.redBright(`insufficient balance`))}
...
if (operationAnswer.operation === "withdraw cash"){let amountAnswer = await inquirer.prompt([
    {
        name: "amount",
